      ...
      <main className="pt-24 pb-20 min-h-screen bg-slate-50">
        ...
        <div className="bg-white border-b border-slate-200 py-12 px-4 sm:px-6 lg:px-8 mb-10">
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-xs font-bold text-blue-600 uppercase tracking-widest mb-3">Step 1 of 2</p>
            ...
            <p className="text-slate-500 text-base max-w-xl mx-auto">
              ...
              custom strategy — so your free call is focused on your specific situation, not a
              generic pitch.
            </p>
            <div className="flex justify-center gap-6 mt-6 text-xs text-slate-400">
              <span>⏱ Takes ~3 minutes</span>
              <span>🔒 Your data is private</span>
              <span>📞 Free 30-min call included</span>
            </div>
          </div>
        </div>
