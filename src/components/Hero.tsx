// Owner: Website Owner | Purpose: Above-the-fold StoryBrand hero â€” customer outcome H1, dual CTAs
    ...
    <section className="bg-slate-900 text-white pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="max-w-3xl">
          {/* Tagline */}
          <p className="text-green-400 font-semibold text-lg tracking-wide mb-3">
            We connect. You grow.
          </p>

          {/* Social proof badge */}
          <div className="inline-flex items-center gap-2 bg-green-600/20 border border-green-500/30 text-green-300 text-sm font-medium px-4 py-1.5 rounded-full mb-6">
            <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
            Trusted by 100+ small businesses
          </div>

          {/* H1 â€” customer outcome, NOT company name */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight mb-6">
            More Clients.{" "}
            <span className="text-green-400">More Revenue.</span>{" "}
            Less Guesswork.
          </h1>

          {/* Subhead â€” what we offer + transformation */}
          <p className="text-lg sm:text-xl text-slate-300 leading-relaxed mb-10 max-w-2xl">
            ...
            into a predictable lead machine â€” so you wake up to a full calendar,
            not an empty inbox.
          </p>
          ...
          <p className="mt-8 text-sm text-slate-500">
            No credit card required &nbsp;Â·&nbsp; 30-minute call &nbsp;Â·&nbsp; No obligation
          </p>
        </div>
      </div>
    </section>
