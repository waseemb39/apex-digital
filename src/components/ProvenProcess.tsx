    ...
    <section className="bg-blue-600 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
          ...
          {steps.map((step, index) => (
            <div key={step.number} className="flex-1 relative">
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-8 left-[calc(100%_-_16px)] w-8 h-0.5 bg-blue-400 z-10" />
              )}
        ...
        <div className="text-center">
          <a
            href={BOOK_CALL_LINK}
            className="inline-flex items-center px-8 py-4 bg-orange-600 text-white font-bold text-base rounded-lg hover:bg-orange-700 transition-colors focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600"
          >
